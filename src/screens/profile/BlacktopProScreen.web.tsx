    ...
    <ScrollView style={styles.container} contentContainerStyle={styles.content}>
      ...
      <View style={styles.webNotice}>
        ...
        <Text style={styles.webNoticeText}>
          Subscribe to Blacktop Pro in the iOS or Android app.
        </Text>
      </View>
    </ScrollView>
  );
...
const styles = StyleSheet.create({
  ...
  webNotice: { flexDirection: 'row', alignItems: 'center', gap: Spacing.sm, backgroundColor: Colors.card, borderRadius: BorderRadius.md, padding: Spacing.md, borderWidth: 1, borderColor: Colors.border, width: '100%' },
  webNoticeText: { flex: 1, fontFamily: 'RobotoCondensed_400Regular', fontSize: FontSize.md, color: Colors.textMuted },
});
