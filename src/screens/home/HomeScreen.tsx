...
const styles = StyleSheet.create({
  container: { flex: 1, backgroundColor: '#04040F' },
  ...
  heroBgScrim: {
    ...
    right: 0,
    bottom: 0,
    // lighter scrim so court photo is more visible — still legible
    backgroundColor: 'rgba(4,4,15,0.35)',
  },
  heroBottomVignette: {
    position: 'absolute',
    bottom: 0,
  ...
  statsBar: {
    ...
    position: 'relative',
    backgroundColor: 'rgba(4,4,15,0.92)',
  },
  statBox: {
    flex: 1,
    alignItems: 'center',
